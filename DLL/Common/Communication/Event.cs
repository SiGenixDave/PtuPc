...
namespace Common.Communication
{
    public class Event
    {
        ...
        private CommunicationError GetFaultIndices(ref UInt32 Oldest, ref UInt32 Newest)
        {
            ...
            Byte[] txMessage = request.GetByteArray(null, ProtocolPTU.PacketType.GET_FAULT_INDICES, ProtocolPTU.ResponseType.COMMANDREQUEST, m_CommDevice.IsTargetBigEndian());
            m_CommDevice.SendMessageToTarget(txMessage);
        ...
        private CommunicationError GetFaultData(UInt32 FaultIndex, UInt16 NumberOfFaults, ref ProtocolPTU.GetFaultDataRes getFaultData)
        {
        ...
        public CommunicationError GetEmbeddedInformation(ref ProtocolPTU.GetEmbeddedInfoRes getEmbInfo)
        {
            ...
            Byte[] txMessage = dpp.GetByteArray(null, ProtocolPTU.PacketType.GET_EMBEDDED_INFORMATION, ProtocolPTU.ResponseType.DATAREQUEST, false);
