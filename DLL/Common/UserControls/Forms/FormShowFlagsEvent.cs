 ...
 *  Project:    Common
 * 
 *  File name:  FormShowFlagsEvent.cs
 * 
 *  Revision History
 *  ----------------
 * 
 *  Date        Version Author          Comments
 *  03/04/11    1.0     K.McD           1.  First entry into TortoiseSVN.
 * 
 *
 */
...
namespace Common.UserControls
{
    ...
    public partial class FormShowFlagsEvent : FormShowFlags
    {
        ...
        public FormShowFlagsEvent(VariableControl variableControl)
        {
            InitializeComponent();
            ...
            m_EventVariableIdentifier = (short)m_VariableControl.Identifier;
            m_EventVariableName = m_VariableControl.VariableNameFieldText;

            // Get a list of the current state of each flag and keep a record to determine if there is a change in state.
            List<FlagState_t> flagStateList = Lookup.EventVariableTable.GetFlagStateList(m_EventVariableIdentifier, m_PreviousValue = GetValue());
            ...
            UpdateTitle(m_EventVariableName, GetValue());
