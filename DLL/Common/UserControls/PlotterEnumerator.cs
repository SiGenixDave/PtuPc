 ...
 * 
 *  03/31/11    1.2     K.McD           1.  Added the ClientForm property.
 *                                      2.  Now uses the PlotterEnumeratorParent user control rather than the standard Plotter user control.
 *                                      3.  Modified the constructor to set the number of graduations on the Y axis according to the number of enumerated text 
 *                                          messages associated with the watch variable.
 *                                      4.  Added a Debug.Assert to the constructor the ensure that the oldIdentifier parameter corresponds to an enumerator watch variable.
...
namespace Common.UserControls
{
    ...
    /// </summary>
    public partial class PlotterEnumerator : UserControl, IPlotterEnumerator
    {
        #region --- Constants ---
        /// <summary>
        /// The key string used to access the 'Remove Selected Plot(s)' context menu item. Value: "m_ToolStripMenuItemRemoveSelected".
        /// </summary>
        public const string KeyToolStripMenuItemRemoveSelected = "m_ToolStripMenuItemRemoveSelected";
        ...
        /// </summary>
        private const int DefaultGraduationsY = 5;
        #endregion --- Constants ---
        ...
        public PlotterEnumerator(short oldIdentifier, float upperDisplayLimit, float lowerDisplayLimit) : this()
        {
            ...
            try
            {
                ...
                Debug.Assert(watchVariable.VariableType == VariableType.Enumerator, "PlotterEnumerator.Ctor() - [watchVariable.VariableType == VariableType.Enumerator]");
            }
            catch (Exception)
            {
                throw new ArgumentException(Resources.MBTWatchVariableNotDefined, "oldIdentifier");
            ...
            // -----------------------------------------------
            // Set the graduations associated with the Y axis.
            // -----------------------------------------------

            // Set the number of graduations on the Y axis to be equal to the highest valid value of the enumerator watch value. This assumes that the values corresponding 
            // to the enumerated text messages start at zero and are contiguous e.g. 0, 1, 2, 3 ... 7 etc.
            int graduationsY;
            try
            {
                graduationsY = Lookup.WatchVariableTableByOldIdentifier.EnumBitLists[watchVariable.EnumBitIdentifier].Count - 1;

                // Ensure that the number of graduations is at least 1.
                if (graduationsY < 1)
                {
                    graduationsY = 1;
                }
            ...
            {
                // Set the number of graduations on the Y axis to the default value.
                graduationsY = DefaultGraduationsY;
            }

            // Set the upper limit of the number of graduations to be equal to the default value as increasing the number beyond this value causes problems with 
            // plotting the control.
            if (graduationsY > DefaultGraduationsY)
            {
                graduationsY = DefaultGraduationsY;
            }

            m_EnumPlotter.GraduationsY = graduationsY;

            #region - [Channel Configuration] -
            m_EnumPlotter.AnalogueType = AnalogueType.SingleAnalogue;
            Channels[0].Enabled = true;
            Channels[0].YAxisName = watchVariable.Units;
            Channels[0].Enabled = true;
            Channels[0].ChannelColor = Color.ForestGreen;

            // Ignore the actual upper and lower limits of the enumerator watch variable, set the upper and lower limits according to the number of possible 
            // enumerated text messages associated with the variable i.e. the lower level should always be zero and the upper level will be equal to the number of 
            // graduations.
            Channels[0].MaximumValue = graduationsY;
        ...
        /// </summary>
        public PlotterEnumerator()
        {
            InitializeComponent();

            // Initialize the ContextMenuStrip control.
            ContextMenuStrip = m_EnumPlotter.ContextMenuStrip;
        ...
        {
            get { return m_EnumPlotter.StartTime; }
            set { m_EnumPlotter.StartTime = value; }
        }
        ...
        {
            get { return m_EnumPlotter.TripTime; }
            set { m_EnumPlotter.TripTime = value; }
        }
        ...
        {
            get { return m_EnumPlotter.IsFaultLog; }
            set { m_EnumPlotter.IsFaultLog = value; }
        }
        ...
        {
            get { return m_EnumPlotter.XRange; }
            set {  m_EnumPlotter.XRange = value; }
        }
        ...
        {
            get { return m_EnumPlotter.TimeDisplayStyle; }
            set { m_EnumPlotter.TimeDisplayStyle = value; }
        }
        ...
        {
            get { return m_EnumPlotter.PlotIntervalMs; }
            set { m_EnumPlotter.PlotIntervalMs = value; }
        }
        ...
        public short Identifier
        {
            ...
            { 
                m_Identifier = value;
                m_EnumPlotter.OldIdentifier = m_Identifier;
        ...
        {
            get { return m_EnumPlotter.Channels; }
        }
        ...
        public new Size Size
        {
            ...
            set
            {
                ...
                int YOffsetLimitChangingPlus = m_EnumPlotter.Height - m_ButtonYAxisPlus.Location.Y;

                // Adjust the size of the plotter to the specified size and adjust the location of the Units label.
                m_EnumPlotter.Size = value;
                ...
                base.Size = new Size(m_EnumPlotter.Size.Width + buttonWidth, m_EnumPlotter.Size.Height);
            }
        }
        ...
        {
            get { return m_EnumPlotter.ClientForm; }
            set { m_EnumPlotter.ClientForm = value; }
        }
