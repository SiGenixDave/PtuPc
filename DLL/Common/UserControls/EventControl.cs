 ...
 * 
 *  03/18/11    1.1     K.McD           1.  Added the ShowHelpPopup() method to display the diagnostic help information associated with the current event identifier.
 * 
 ...
 *                                          is specified.
 * 
 *                                      3.  Added the event handler for the 'Show Definition' context menu 'Click' event.
 * 
 *  03/28/11    1.2     K.McD           1.  Auto-modified as a result of name changes to a number of constants.
 * 
 */
...
namespace Common.UserControls
{
    ...
    public partial class EventControl : VariableControl
    {
        #region --- Constructors ---
        /// <summary>
        ...
        protected void ShowHelpPopup()
        {
            ...
            int helpIndex = Lookup.EventVariableTable.Items[Identifier].HelpIndex;
        ...
        public override int Identifier
        {
            ...
            set
            {
                ...
                try
                {
                    m_LabelNameField.Text = Lookup.EventVariableTable.Items[m_Identifier].Name;
                    m_LabelUnitsField.Text = Lookup.EventVariableTable.Items[m_Identifier].Units;
                    General.GetDecimalPlaces(Lookup.EventVariableTable.Items[m_Identifier].ScaleFactor, out m_DecimalPlaces);
                }
                catch (Exception)
                {
